...
B = '\x1b[1;96m'
P = '\x1b[1;97m'
ua_poco = 'Mozilla/5.0 (Linux; Android 11; M2010J19CI) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/101.0.0.0 Mobile Safari/537.36'
...
ua = random.choice([
    ...
    ua_galaxys10,
    ua_lenovo])
logo = "╔═══╦╗─╔╦═══╦═══╦═══╦╗╔╗╔╗\n║╔═╗║║─║║╔═╗╠╗╔╗║╔═╗║║║║║║\n║╚══╣╚═╝║║─║║║║║║║─║║║║║║║\n╚══╗║╔═╗║╚═╝║║║║║║─║║╚╝╚╝║\n║╚═╝║║─║║╔═╗╠╝╚╝║╚═╝╠╗╔╗╔╝\n╚═══╩╝─╚╩╝─╚╩═══╩═══╝╚╝╚\n..::::..::..:::::..:::......:::..:::::..::....::..::::::::\x1b[1;92m ------------------------------------------\n\x1b[0;91m\x01             CREATE FILE EASILY:)                 \x1b[0m\n-----------------------------------------------\n\x1b[0;91m \x1a OWNERS : ADNAN ISLAM - SHADOW SQUAD \n\x1b[0;97m \x1a Github : SHADOW.SQUAD.BROTHEr\n\x1b[0;91m \x1a Note   : Use  Kiwi Browser Token"
...
def login():
    ...
    try:
        ...
        if ___token___ in ('', ' '):
            exit('%s[%s!%s]%sMAMA TOKEN LAGAO ' % (P, M, P, M))
        xwx = requests.get('https://graph.facebook.com/me/?access_token=%s' % ___token___).json()
        print '%s[%s*%s]%s WelCome To SHADOW %s %s' % (B, P, B, P, H, xwx['name'].lower())
...
def menu():
    ...
    print '\x1b[1;91mExample: /sdcard/SHADOW.txt'
    print ''
